...
export default function SecurityPage() {
  return (
    <LegalPage
      ...
      title={l("Verify the listing. Report vulnerabilities privately.", "验证目录条目，私下报告漏洞。")}
      lead={l(
        "Before directory approval, reports target the submission candidate; afterward, fixes target the latest published Gloamere Workflows version.",
        "目录获批前，报告针对提交候选版；获批后，修复目标为最新发布的 Gloamere Workflows 版本。",
      )}
    >
      <section>
        <h2><T value={l("Supported versions", "支持版本")} /></h2>
        <p><T value={l(
          "The first directory version is not yet available. Historical repository releases remain visible for traceability but are not an active compatibility or security-support surface.",
          "首个目录版本尚未开放。历史仓库版本会为可追溯性保留，但不属于当前兼容性或安全支持范围。",
        )} /></p>
      </section>
      <section>
        ...
        <p><T value={l(
          "Gloamere will acknowledge the report through GitHub and coordinate disclosure after a fix is available. The directory candidate does not promise a fixed response-time SLA.",
          "Gloamere 会通过 GitHub 确认报告，并在修复可用后协调披露。目录候选阶段不承诺固定响应时间 SLA。",
        )} /></p>
      </section>
      <section>
        <h2><T value={l("Security boundary", "安全边界")} /></h2>
        <ul>
          <li><T value={l("The submission candidate contains no Gloamere backend, telemetry, hooks, plugin UI, MCP server, or background service.", "提交候选版不包含 Gloamere 后端、遥测、Hook、插件 UI、MCP 服务器或后台服务。")} /></li>
          ...
          <li><T value={l("Install only from the verified official directory listing after it becomes available.", "目录条目上线后，仅从经过验证的官方目录条目安装。")} /></li>
