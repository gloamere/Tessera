...
CURRENT_DECISION = "universal-workflows-v4-release"


class ArchitectureDocsTests(unittest.TestCase):
    def test_current_index_points_to_universal_decision_and_migration(self) -> None:
    ...
    def test_universal_workflows_decision_is_accepted(self) -> None:
